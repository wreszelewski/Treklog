...
describe("trackList", function() {
  ...
  describe("createTrackList", () => {
    it('should create properly formatted user DOM Element', () => {
      ...
      expect(wrapper.innerHTML).toEqual('<a href="2017/test" class="collection-item avatar"><i class="material-icons circle green">terrain</i><span class="title">test - 02.09.2017</span><p>test</p></a>');
    ...
    it('should create properly formatted admin DOM Element', () => {
            ...
            let wrapper = document.createElement('div');
            wrapper.appendChild(trackList[0]);
            expect(wrapper.innerHTML).toEqual('<a href="admin/2017/test" class="collection-item avatar"><i class="material-icons circle green">terrain</i><span class="title">test - 02.09.2017</span><p>test</p></a>');
  ...
  it('should create multiple elements sorted by created date', () => {
    ...
    const trackList = TrackList.createTrackList(tracksPerYear, mode);
    const names = trackList.map((track => track.toString()));
